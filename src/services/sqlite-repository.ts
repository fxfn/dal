...
> implements IRepository<TTable['$inferSelect'], TTable['$inferInsert']> {
  ...
  @inject(ISqliteDataProvider)
  protected dataProvider!: ISqliteDataProvider<ExtractTables<TSchema>>
  ...
  constructor(fullSchema: TSchema, tableName: TKey) {
    ...
    if (this.dataProvider === undefined) {
      throw new MissingDataProviderError(`${this.constructor.name} requires an SQLite DataProvider to be registered`)
    }
  }
